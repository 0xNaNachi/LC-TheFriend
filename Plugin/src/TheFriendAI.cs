...
namespace TheFriend {
    ...
    // You may be wondering, how does the The Friend know it is from class TheFriendAI?
    // Well, we give it a reference to to this class in the Unity project where we make the asset bundle.
    // Asset bundles cannot contain scripts, so our script lives here. It is important to get the
    // reference right, or else it will not find this file. See the guide for more information.

    class TheFriendAI : EnemyAI
    {
        ...
        public override void Start() {
            base.Start();
            LogIfDebugBuild("The Friend Spawned");
        ...
        public override void Update() {
            ...
            if(targetPlayer != null && (state == (int)State.InitiateChase || state == (int)State.SearchingForPlayer)){
        ...
        IEnumerator SwingAttack() {
            ...
            if(currentBehaviourStateIndex != (int)State.HuntingPlayer){
                yield break;
            }
            SwitchToBehaviourClientRpc((int)State.InitiateChase);
        }
        ...
        public override void OnCollideWithPlayer(Collider other) {
            ...
            {
                LogIfDebugBuild("The Friend Collision with Player!");

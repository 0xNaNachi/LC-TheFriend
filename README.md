...
This repository contains the full source code for the The Friend for Lethal Company, including the Unity project which can be used to build its asset bundle. The guide part of this project can be found at https://lethal.wiki/dev/apis/lethallib/custom-enemies/overview.

> [!NOTE]
> The wiki page might be slightly out of date regarding how the The Friend prefab is constructed.
...
> [!TIP]  
> You can use `Ctrl` + `Shift`+ `F` to search every file in both Visual Studio and Visual Studio Code. This can for example help you find every instance of `TheFriend` inside files in the whole project. Do note however that this does not apply to filenames.  
...
[XuuXiao](https://github.com/XuuXiao/) - porting LC-TheFriend for LC v50  
